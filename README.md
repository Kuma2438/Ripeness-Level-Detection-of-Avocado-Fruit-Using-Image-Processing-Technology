...
* **🎓 ระบบเทรนและกำหนด Label สายพันธุ์ใหม่ (Variety Trainer & Labeler Studio):**
  ...
  * บันทึกน้ำหนักและพารามิเตอร์โมเดลเข้าไฟล์ `models/variety_model.pkl` อัตโนมัติ
...
├── models/variety_model.pkl           # ไฟล์โมเดลสายพันธุ์อะโวคาโดที่ผ่านการเทรนแล้ว
├── dataset/
...
4. กดปุ่ม **"⚡ เริ่มเทรนโมเดลสายพันธุ์ (Start Training)"** ระบบจะสร้างไฟล์ `models/variety_model.pkl`
